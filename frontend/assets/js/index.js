...
$(document).ready(function() {
  ...
  $(window).load(function() {
    ...
    insertResponseMessage('I am your personal AI for vaccination service. How can I help you?');
  });
  ...
  function insertResponseMessage(content) {
    ...
    setTimeout(function() {
      ...
      $('<div class="message new">' + content + '</div>').appendTo($('.mCSB_container')).addClass('new');
